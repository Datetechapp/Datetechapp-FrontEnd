...
import { PhotoUploader, VideoUploader, GenderDropdawn } from ".";
import { ModalUploadVideo, Locations } from ".";
...
export const Questionnaire = () => {
       ...
       return (
              <div className={css.questionnaireWrapper}>
                     ...
                     <div className={`${css.main} ${step === 0 ? css.nameQuestion :
                            step === 1 ? css.birthdayQuestion :
                                   step === 2 ? css.genderQuestion :
                                          step === 3 ? css.genderFilterQuestion :
                                                 step === 4 ? css.photoQuestion :
                                                        step === 5 ? css.videoQuestion :
                                                               css.lastQuestion}`}>
                            {step === 0 && <QuestionBlock
                                   title={textForName}
                            ...
                            {step === 2 &&
                                   <div className={css.blockWithPreviousArrow}>
                                          ...
                                          <div className={css.form}>
                                                 ...
                                                 <GenderDropdawn onChange={handleGenderChange} showGenders={true} gender={gender} sex={sex} />
                                                 <Button
                            ...
                            {step === 3 && <div className={css.blockWithPreviousArrow}>
                                   <PreviousStep
                                          className={css.previousStepArrow}
                                          onClick={handlePreviousStep}
                                   />
                            ...
                            {step === 5 && <div className={css.blockWithPreviousArrow}>
                                   <PreviousStep
                                          className={css.previousStepArrow}
                                          onClick={handlePreviousStep}
                                   />
                                   <div className={css.form}>
                                          ...
                                          <VideoUploader
                                                 ...
                                                 video={video}
                                          />
                                          {showModalUploadVideo && <ModalUploadVideo
                            ...
                            {step === 6 && <div className={css.blockWithPreviousArrow}>
                                   <PreviousStep
                                          className={css.previousStepArrow}
                                          onClick={handlePreviousStep}
                                   />
