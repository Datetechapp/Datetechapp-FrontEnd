        ...
        <ModalBase width="600px" height="600px">
          <div className="ModalWelcome">
            ...
            <div className="ModalWelcome_Wrapper">
              ...
              <p>
                We are confident that you will enjoy using our platform to meet
                new people. Our app is unique in that you can view video
                presentations of other users before contacting them, allowing
                you to immediately understand if a person fits your criteria. We
                hope you find what you're looking for here and enjoy using our
                app!
              </p>
            </div>
          </div>
