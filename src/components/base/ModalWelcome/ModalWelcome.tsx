                ...
                <ModalBase width='600px' height='600px'>
                    <div className='ModalWelcome' >
                        <div className='ModalWelcome_CloseModal'>
                            <button className='CloseModal__Btn-close' onClick={() => setModal(false)}>
                                <img className='Btn-close_img' src={close} alt="close" />
                            </button>
                        </div>
                        <div className='ModalWelcome_Wrapper'>
                            <img src={logo} alt='logo' />
                            <h3>Welcome to our dating upp!</h3>
                            <p>We are confident that you will enjoy using our platform to meet new people. Our app is unique in that you can view video presentations of other users before contacting them, allowing you to immediately understand if a person fits your criteria. We hope you find what you're looking for here and enjoy using our app!</p>
                        </div>
                    </div>
                </ModalBase>
            ) : (<></>)}
