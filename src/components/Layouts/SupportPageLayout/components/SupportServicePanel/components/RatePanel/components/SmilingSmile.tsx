...
export function SmilingSmile({ isActive }: { isActive: boolean }) {
  return (
    <svg
      width="40"
      height="40"
    ...
    >
      <g clip-path="url(#clip0_8209_61510)">
        <path
        ...
        />
        <path
          d="M15.834 25C16.3771 25.5543 17.0254 25.9947 17.7409 26.2954C18.4563 26.596 19.2246 26.7509 20.0007 26.7509C20.7767 26.7509 21.545 26.596 22.2604 26.2954C22.9759 25.9947 23.6242 25.5543 24.1673 25"
