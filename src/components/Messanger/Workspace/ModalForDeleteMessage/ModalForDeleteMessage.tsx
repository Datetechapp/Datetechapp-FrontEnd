...
export const ModalForDeleteMessage: FC<ModalForFixProps> = ({ isOpen, onRequestClose, onRequestDelete, selectedMessageId }) => {
              ...
              >
                     <div className={css.modalDeleteBlock}>
                            ...
                            <div className={css.buttonBlock}>
                                   <Button className={css.btnYes} onClick={onRequestClose}>Yes</Button>
