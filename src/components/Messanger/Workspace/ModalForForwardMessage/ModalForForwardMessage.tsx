...
export const ModalForForwardMessage: FC<ModalForForwardProps> = ({
  isOpen,
  onRequestClose,
  onRequestForward,
  selectedMessageId,
  ...
  return (
    ...
    >
      <div className={css.modalForwardBlock}>
        <h2 className={css.modalForwardMessageTitle}>
          Select a chat from the list on the right to whom you would like to
          forward the message
        </h2>
        <div className={css.buttonBlock}>
          ...
          <Button className={css.btnSelect} onClick={onRequestClose}>
            Select
          </Button>
        </div>
      </div>
