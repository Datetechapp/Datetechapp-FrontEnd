...
export const ModalForFixMessage: FC<ModalForFixProps> = ({ isOpen, onRequestClose, onRequestPinned, selectedMessageId }) => {
       ...
       return (
              ...
              >
                     <div className={css.modalFixBlock}>
                            <h2 className={css.modalFixMessageTitle}>Would you like to pin this message?</h2>
                            <div className={css.buttonBlock}>
                                   <Button className={css.btnCancel} onClick={onRequestClose}>Cancel</Button>
                                   <Button className={css.btnYes} onClick={() => {
                                          onRequestClose();
