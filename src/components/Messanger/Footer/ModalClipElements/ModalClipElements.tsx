...
export const ModalClipElements: FC<ModalClipElementsProps> = ({ file, onClose, value, onChange }) => {
              ...
              <div className={css.background} onClick={handleBackgroundClick}>
                     ...
                     <div className={css.blockClipElemWithDescription}>
                            <div className={css.centeredContainer}>
                                   <img src={URL.createObjectURL(file)} className={css.clipElem} alt="Selected" />
                            </div>
